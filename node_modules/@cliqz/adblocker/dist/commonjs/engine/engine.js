...
class FilterEngine extends events_js_1.EventEmitter {
    ...
    static deserialize(serialized) {
        ...
        engine.htmlFilters = html_js_1.default.deserialize(buffer, config);
    ...
    cosmeticFilters = [], networkFilters = [], preprocessors = [], config = new config_js_1.default(), lists = new Map(), } = {}) {
        ...
        // HTML filters
        this.htmlFilters = new html_js_1.default({ config: this.config });
        // Injections
        ...
        if (networkFilters.length !== 0) {
            ...
            for (const filter of networkFilters) {
                ...
                this.emit('filter-matched', { filter, exception }, {
                    request,
                    filterType: lists_js_1.FilterType.NETWORK,
                });
